...
void
SerialPort_resetTimeout(SerialPort self, int timeout, uint64_t rcv_sys_time_ms);

void
SerialPort_getTimeout(SerialPort self, uint64_t *rcv_sys_time_ms);
...
*/
int
SerialPort_checkTimeout(SerialPort self);
