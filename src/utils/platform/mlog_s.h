 ...
 */
#define SLOG(level, fmt, ...)             mlogWrite_(0, level, 0, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
...
#define SLOG_RAW(level, fmt, ...)         mlogWrite_(0, level, 1, __FUNCTION__, __LINE__, fmt, ##__VA_ARGS__)
